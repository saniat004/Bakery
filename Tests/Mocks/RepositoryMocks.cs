...
namespace Tests.Mocks
{
    public class RepositoryMocks
    {
        public static Mock<ICakeRepository> GetCakeRepository()
        {
            ...
            mockCakeRepository.Setup(repo => repo.CakesOfTheWeek).Returns(cakes.Where(p => p.IsCakeOfTheWeek));
        ...
        public static Mock<ICategoryRepository> GetCategoryRepository()
        {
            ...
            new Category { CategoryId = 1, CategoryName = "Fruit cakes" },
            new Category { CategoryId = 3, CategoryName = "Pound cakes" },
            new Category { CategoryId = 4, CategoryName = "Sponge cakes" },
            new Category { CategoryId = 5, CategoryName = "Genoise cakes" },
            new Category { CategoryId = 7, CategoryName = "Baked Flourless cakes" },
            new Category { CategoryId = 8, CategoryName = "Chiffon  cakes" }
           };
        ...
        public static Dictionary<string, Category> Categories
        {
            get
            {
                if (_categories == null)
                {
                    ...
                    {
            new Category { CategoryName = "Fruit cakes" },
            new Category {  CategoryName = "Pound cakes" },
            new Category { CategoryName = "Sponge cakes" },
            new Category { CategoryName = "Genoise cakes" },
            new Category {  CategoryName = "Baked Flourless cakes" },
            new Category { CategoryName = "Chiffon  cakes" }
                    };
